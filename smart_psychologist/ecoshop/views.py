...
def productPage(request):
    ...
    return render(request,'ecoshop/products.html',{'products':products,'category':category})


def product_by_category(request,id):
    pro_cata = ProductDetails.objects.filter(product_category=id)
    category = ProductCategory.objects.all()
    return render(request,'ecoshop/productbycategory.html',{'products':pro_cata,'category':category})
...
def productDetail(request,id):
    ...
    return render(request,'ecoshop/productdetail.html',{'products':product,'item_already_in_cart':item_already_in_cart})
        ...
        if request.user.is_authenticated:
            ...
            if cart_product:
                for p in cart_product:
                    ...
                    amount += tempamount
            return render(request,'ecoshop/addtocart.html',{'carts':cartProduct,'amount':amount,'totalamount':amount+shippingcost,'shippingcost':shippingcost})
        else:
...
class OrderPage(View):
    def get(self,request):
        ...
        return render(request,'ecoshop/orders.html',{'orders':orders})
